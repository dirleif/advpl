...
Consulta específica para tabelas cadastradas na ZC5
...
Define MsDialog oDlg From 000, 000 To 390, 515 Title "Consulta Padrão - Campos do Sistema" Pixel Of oMainWnd		
	...
	Add Column oColumn2  DATA { || If(__LANGUAGE == "SPANISH",ZC5SX3->X3_TITSPA,If(__LANGUAGE == "ENGLISH",ZC5SX3->X3_TITENG,ZC5SX3->X3_TITULO)) } Title "Título" Size Len(ZC5SX3->X3_TITULO) Of oBrowse
